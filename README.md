...
| 组件                            | 当前约束                                                                                                                                            | 门禁                                                                            |
| ------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| ThesisLedger 主仓               | 0.1.0；Account/Position API V1 直接切换到新账户模型                                                                                                 | current baseline `20260905000000_fresh_database_baseline` 与 schema marker 一致 |
